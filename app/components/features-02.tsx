        ...
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              There are many variations available, but the majority have suffered alteration in some
                        ...
                        <div className="mb-5">
                          <div>
                            ...
                            <p className="text-slate-400">
                              ...
                              integrations, lower user friction, incorporate rich user profiling,
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Login box must find the right balance for the user convenience, privacy and
                security.
              </p>
            </div>
            {/* Feature */}
