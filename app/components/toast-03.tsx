    ...
    <>
      {open && (
        <div className={className} role="alert">
          <div className="inline-flex min-w-[20rem] px-4 py-2 rounded-sm text-sm bg-white dark:bg-slate-800 shadow-lg border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-100">
            <div className="flex w-full justify-between items-start">
              ...
              <button
                className="dark:text-slate-400 opacity-70 hover:opacity-80 ml-3 mt-[3px]"
