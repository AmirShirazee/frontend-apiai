...
const variants = {
  base: "relative rounded-md p-4 w-96 flex justify-center items-center flex-col cursor-pointer border border-dashed border-yourColor-300 transition-colors duration-200 ease-in-out bg-yourBackgroundColor",
  active: "border-2",
  disabled:
...
export type FileState = {
  file: File;
  key: string;
  progress: "PENDING" | "UPLOADING" | "COMPLETE" | "ERROR" | number;
};
      ...
      onDrop: (acceptedFiles) => {
        if (acceptedFiles.length > 0) {
          ...
          const addedFile: FileState = {
            // Explicitly type this as FileState
            file,
              ...
              <div className="flex items-center gap-2 text-white">
                ...
                <div className="flex w-12 justify-end text-xs">
                  {progress === "PENDING" ? (
                    ...
                    <div>{Math.round(progress as number)}%</div>
                  ) : (
